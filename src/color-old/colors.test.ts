...
test('@tools/color/colors ', () => {
  test('fromCssColor', () => {
    should('handle legacy style RGB', () => {
      ...
      assert(getRgb(fromCssColor('rgb(12,34,56)')!)).to.haveExactElements([
        12, 34, 56,
      ]);
    });
    ...
    should(
      'return null for RGB if one of the components is not a number',
      () => {
    ...
    should('handle legacy style RGBA', () => {
      // tslint:disable-next-line:no-non-null-assertion
      assert(getRgb(fromCssColor('rgba(12,34,56,.78)')!)).to.haveExactElements([
        12, 34, 56,
      ]);
    });
    ...
    should('handle legacy style RGBA with white spaces', () => {
      // tslint:disable-next-line:no-non-null-assertion
      assert(
        getRgb(fromCssColor('rgba(  12,   34, 56,   .78  )')!),
      ).to.haveExactElements([12, 34, 56]);
    });

    should(
      'handle legacy style RGBA if one of the RGB components is not an integer',
      () => {
        // tslint:disable-next-line:no-non-null-assertion
        assert(
          getRgb(fromCssColor('rgba(12, 3.6, 56, .78)')!),
        ).to.haveExactElements([12, 4, 56]);
      },
    );

    should('handle functional RGB', () => {
      // tslint:disable-next-line:no-non-null-assertion
      assert(getRgb(fromCssColor('rgb(12 34 56/0.78)')!)).to.haveExactElements([
        12, 34, 56,
      ]);
    });
    ...
    should('handle functional RGB with white spaces', () => {
      // tslint:disable-next-line:no-non-null-assertion
      assert(
        getRgb(fromCssColor('rgb(12    34  56  /   0.78)')!),
      ).to.haveExactElements([12, 34, 56]);
    });

    should(
      'return null for RGB if one of the components is not an integer',
      () => {
    ...
    should('handle legacy style HSL', () => {
      // tslint:disable-next-line:no-non-null-assertion
      assert(getHsl(fromCssColor('hsl(12,34%,56%)')!)).to.haveExactElements([
        12, 0.34, 0.56,
      ]);
    });
    ...
    should('handle legacy style HSL with white spaces', () => {
      // tslint:disable-next-line:no-non-null-assertion
      assert(
        getHsl(fromCssColor('hsl(12,   34  %, 56  % )')!),
      ).to.haveExactElements([12, 0.34, 0.56]);
    });
    ...
    should('handle legacy style HSLA', () => {
      // tslint:disable-next-line:no-non-null-assertion
      assert(
        getHsl(fromCssColor('hsla(12,34%,56%,.78)')!),
      ).to.haveExactElements([12, 0.34, 0.56]);
    });
    ...
    should('handle functional HSL', () => {
      // tslint:disable-next-line:no-non-null-assertion
      assert(
        getHsl(fromCssColor('hsl(12 34% 56%/0.78)')!),
      ).to.haveExactElements([12, 0.34, 0.56]);
    });
    ...
    should('handle hex strings', () => {
      // tslint:disable-next-line:no-non-null-assertion
      assert(getRgb(fromCssColor('#abcdef')!)).to.haveExactElements([
        0xab, 0xcd, 0xef,
      ]);
    });
    ...
    should('handle short hex strings', () => {
      // tslint:disable-next-line:no-non-null-assertion
      assert(getRgb(fromCssColor('#abc')!)).to.haveExactElements([
        0xaa, 0xbb, 0xcc,
      ]);
    });
    ...
    should('handle hex strings with alpha', () => {
      // tslint:disable-next-line:no-non-null-assertion
      assert(getRgb(fromCssColor('#abcdef12')!)).to.haveExactElements([
        0xab, 0xcd, 0xef,
      ]);
    });
    ...
    should('handle short hex strings with alpha', () => {
      // tslint:disable-next-line:no-non-null-assertion
      assert(getRgb(fromCssColor('#abcd')!)).to.haveExactElements([
        0xaa, 0xbb, 0xcc,
      ]);
    });
