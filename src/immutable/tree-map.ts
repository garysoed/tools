...
//       private readonly childNodes_: ImmutableMap<K, TreeMap<K, V>> = createImmutableMap([])) { }
...
//         .reduce((prevValue, value) => prevValue.addAll(value), ImmutableList.of<TreeMap<K, V>>([]));
//     return createImmutableList([this, ...descendants]);
//   }
...
//     return new TreeMap(value, createImmutableMap<K, TreeMap<K, V>>([...children]));
//   }
...
//     const resultsMap = createImmutableMap(results);
