...
describe('collection.Maps', () => {
  describe('fromArray', () => {
    it('should create the map correctly', () => {
      const record = Maps.fromArray(['1', undefined, 'a', null]).asRecord();
  ...
  describe('fromNumericalIndexed', () => {
    it('should create the map correctly', () => {
      let index = {} as {[index: number]: string};
      index[2] = 'b';
      index[3] = 'c';
      index[25] = 'z';

      const result = Maps.fromNumericalIndexed<string>(index).asRecord();
  ...
  describe('fromRecord', () => {
    it('should return the correct map', () => {
      const result = Maps.fromRecord({'a': 1, 'b': 2}).asRecord();
